...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/function@v0.3.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/function/actions/workflows/test.yml/badge.svg?branch=v0.3.3
[test-url]: https://github.com/stdlib-js/function/actions/workflows/test.yml?query=branch:v0.3.3
